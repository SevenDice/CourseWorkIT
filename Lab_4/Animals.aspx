...
<body>
    <form id="form1" runat="server">
        ...
        <div>
            ...
            <div>
                <asp:GridView HorizontalAlign="Center"  ID="AnimalsTable" runat="server" DataKeyNames="IdA" AutoGenerateColumns="False" AutoGenerateDeleteButton="True" AutoGenerateEditButton="True" AllowSorting="True" OnSorting="AnimalsTable_Sorting">
