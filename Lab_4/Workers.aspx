...
<body>
    <form id="form1" runat="server">
        <div>
            <h1 style="font-family: Impact; background-color: greenyellow; text-align: center;">Просмотр работников</h1>
            <span style="display: block; margin: 10px"><a href="/Main.aspx">Назад</a></span>
            <div>
                <asp:GridView ID="WorkersTable" runat="server" HorizontalAlign="Center" AutoGenerateColumns="False" AutoGenerateDeleteButton="True" AutoGenerateEditButton="True" AllowSorting="True" DataKeyNames="IdW" OnRowDeleting="WorkersTable_RowDeleting" OnRowEditing="WorkersTable_RowEditing" OnRowCancelingEdit="WorkersTable_RowCancelingEdit" OnRowUpdating="WorkersTable_RowUpdating" OnSorting="WorkersTable_Sorting">
                ...
                <div class="floatableDiv" style="margin: 15px auto 10px; width: 800px">
                    <div style="float: left; margin-right: 15px; border: 1px black dashed;">
                        ...
                        <tr>
                            <td>Фамилия:</td>
                            <td>
                                <asp:TextBox ID="LastNameTbx" runat="server" Width="160px"></asp:TextBox></td>
                        </tr>
                        <tr>
                            <td>Имя:</td>
                            <td>
                                <asp:TextBox ID="FirstNameTbx" runat="server" Width="160px"></asp:TextBox></td>
                        </tr>
                        <tr>
                            <td>Отчество:</td>
                            <td>
                                <asp:TextBox ID="SurnameTbx" runat="server" Width="160px"></asp:TextBox></td>
                        </tr>
                        <tr>
                            <td>Зарплата:</td>
                            <td>
                                <asp:TextBox ID="SalaryTbx" runat="server"></asp:TextBox></td>
                        </tr>
                        <tr>
                            <td>Инвентарь:</td>
                            <td>
                                <asp:DropDownList ID="InventaryDropDown" runat="server" /></td>
                        </tr>
                        <tr>
                            <td>Отдел:</td>
                            <td>
                                <asp:DropDownList ID="DepartmentDropDown" runat="server" /></td>
                        </tr>
                        <tr>
                            <td>Логин:</td>
                            <td>
                                <asp:TextBox ID="LoginTbx" runat="server"></asp:TextBox></td>
                        </tr>
                        <tr>
                            <td>Пароль:</td>
                            <td>
                                <asp:TextBox ID="PwdTbx" runat="server"></asp:TextBox></td>
                        </tr>
                        <tr>
                    ...
                    <div style="float: left; border: 1px black dashed;">
                        <table>
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="TotalSalaryTbx" runat="server" Width="160px"></asp:TextBox></td>
                            </tr>
                            <tr>
                                <td colspan="2" style="text-align: center">
