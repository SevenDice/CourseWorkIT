        ...
        <div style="margin-top: 15px;">
            <div style="float: left; margin-right: 15px; border: 1px black dashed;">
                <table>
                    <tr>
                        <td>Фамилия:</td>
                        <td><asp:TextBox ID="TextBox6" runat="server" Width="160px"></asp:TextBox></td>
                    </tr>
                    <tr>
                        <td>Имя:</td>
                        <td><asp:TextBox ID="TextBox5" runat="server" Width="160px"></asp:TextBox></td>
                    </tr>
                    <tr>
                        <td>Отчество:</td>
                    ...
                    <tr>
                        <td colspan="2" style="text-align: center"><asp:Button ID="Button1" runat="server" OnClick="Button1_Click" Text="Добавить" /></td>
                    </tr>
                </table>
            </div>
            <div style="float: left; border: 1px black dashed;">
                <table>
                    <tr>
                        ...
                        <td><asp:TextBox ID="TextBox9" runat="server" Width="160px"></asp:TextBox></td>
                    </tr>
                    <tr>
                        <td colspan="2" style="text-align: center"><asp:Button ID="Button3" runat="server" OnClick="Button2_Click" Text="Рассчитать" /></td>
                    </tr>
                </table>
            </div>
        </div>
