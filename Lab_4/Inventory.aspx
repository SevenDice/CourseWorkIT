...
<body>
    <form id="form1" runat="server">
        ...
        <div>
            ...
            <div>
                <asp:GridView HorizontalAlign="Center"  ID="InventoryTable" runat="server" DataKeyNames="IdI" AutoGenerateColumns="False" AutoGenerateDeleteButton="True" AutoGenerateEditButton="True" AllowSorting="True" OnSorting="InventoryTable_Sorting" OnRowCancelingEdit="InventoryTable_RowCancelingEdit" OnRowDeleting="InventoryTable_RowDeleting" OnRowEditing="InventoryTable_RowEditing" OnRowUpdating="InventoryTable_RowUpdating">
