...
<body>
    <form id="form1" runat="server">
        ...
        <div>
            ...
            <div>
                <asp:GridView HorizontalAlign="Center"  ID="CulturesTable" runat="server" DataKeyNames="IdC" AutoGenerateColumns="False" AutoGenerateDeleteButton="True" AutoGenerateEditButton="True" AllowSorting="True" OnSorting="CulturesTable_Sorting">
